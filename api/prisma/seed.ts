...
async function main() {
    ...
    const goals = Array.from({ length: 25 }).map((_, i) => ({
        ...
        oldCategories: [categories[i % categories.length]],
    }));
    ...
    const realisticGoals = [
        ...
        },
        {
            ...
            oldCategories: ['Puzzle', 'Exploration'],
            difficulty: 13,
        },
        {
        ...
        },
        {
            ...
            oldCategories: ['Stealth', 'Time Challenge'],
            difficulty: 19,
        },
        {
        ...
        },
        {
            ...
            oldCategories: ['Stealth', 'Resource Management'],
            difficulty: 22,
        },
        {
        ...
        },
        {
            ...
            oldCategories: ['Combat', 'Time Challenge'],
            difficulty: 24,
        },
        ...Array.from({ length: 54 }).map((_, i) => ({
            ...
            oldCategories: [
                realisticCategories[i % realisticCategories.length],
            ],
            difficulty: ((i + 1) % 25) + 1,
        })),
    ];
