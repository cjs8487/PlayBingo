...
function RacetimeSettings() {
    ...
    return (
        <Box display="flex" width="100%" columnGap={2}>
            <Box display="flex" columnGap={1} alignItems="center" flexGrow={1}>
                <FormikTextField
            ...
            <FormControl sx={{ flexGrow: 3 }}>
                <InputLabel id="racetime-goal-label">Racetime Goal</InputLabel>
                <Select
                    id="racetime-goal"
...
export default function SettingsForm({ gameData }: FormProps) {
    return (
        <Formik
            initialValues={{
                name: gameData.name,
            ...
            <Form>
                ...
                >
                    ...
                    <Box>
                        ...
                        />
                        <Typography variant="caption">
                            Enter each word on a new line. No numbers or special
